  ...
  return (
    <div className="w-screen h-screen justify-center bg-white lg:flex items-center overflow-auto p-8">
      <div className="container mx-auto grid grid-cols-1 gap-4 items-center">
        ...
        />
        <div>
          <div className="text-2xl font-black text-cyan-500 mb-20">
          ...
          <div className="text-2xl font-black text-red-500 mb-20">
          ...
          <div className="text-2xl font-black text-purple-500 mb-20">
          ...
          <div className="text-2xl font-black text-yellow-500 mb-20">
